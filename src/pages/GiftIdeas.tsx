    ...
    queryFn: async () => {
      ...
      return data.map(item => {
        ...
        return {
          ...
          aiReasoning: "This item was recommended based on your search criteria.",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-4xl font-display font-bold">Gift Ideas</h1>
          <p className="text-muted-foreground mt-2">Browse all gift ideas generated from searches</p>
        </div>
